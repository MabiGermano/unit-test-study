...
class HostingVacancyServiceTest {
    ...
    public void editarVagaComSucesso(){
        ...
        HostingVacancyRepository.getInstance().add(generalInstances.hostingVacancy3);

        HostingVacancy hostingVacancy = HostingVacancyRepository.getInstance().getById(1);
        hostingVacancy.setDescription(newDescription);
        hostingVacancyService.editarVaga(hostingVacancy);
        HostingVacancy hostingVacancyUpdated = HostingVacancyRepository.getInstance().getById(1);
